...
# -*- coding: utf-8 -*-
"""
ヒトタンパク質詳細情報取得（150,001〜205,294件目）- バッチAPI最適化版
"""
import requests
import csv
import time
...
def get_protein_details_batch(
    ...
    output_file="protein_details_150k_to_end.csv",
    start_index=150000,
    batch_size=100,
    max_workers=20
):
    ...
    print(f"取得範囲: {start_index+1}〜{start_index+total_proteins}件目")
