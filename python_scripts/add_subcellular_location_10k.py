...
# -*- coding: utf-8 -*-
"""
all_human_protein_database_with_IDR-CCinformation.csvの最初の1万件にSubcellular Location情報を追加
"""
import requests
import csv
import time
...
def add_subcellular_location_10k():
    """
    CSVファイルの最初の1万件にSubcellular Location列を追加
    """
    input_file = "../IDR+CC_DB/all_human_protein_database_with_IDR-CCinformation.csv"
    output_file = "../all_human_protein_database_with_IDR-CCinformation_10k_with_location.csv"
    ...
    print(f"処理対象: {total_proteins:,} 件（最初の1万件）")
